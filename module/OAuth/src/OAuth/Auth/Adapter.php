...
class Adapter extends AbstractModel implements AdapterInterface {
	...
	private function _queryIdentity() {
		...
		$user = $em->getRepository ( 'OAuth\Entity\User' )->findOneBy ( array (
	...
	public function authenticate() {
		...
		if (! $user) {
			...
			$result = $bcrypt->verify ( $this->_credential, $user->$getCredential());
